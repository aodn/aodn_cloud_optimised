...
from aodn_cloud_optimised.lib.schema import (generate_pyarrow_schema_from_s3_netcdf, create_pyarrow_schema_from_list, create_pyrarrow_schema_from_dict,
                                             create_pyarrow_schema, generate_json_schema_from_s3_netcdf)
...
class TestNetCDFSchemaGeneration(unittest.TestCase):
    ...
    def test_generate_pyarrow_schema_from_s3_netcdf(self, mock_s3fs, mock_xr_open_dataset):
        ...
        result_schema = generate_pyarrow_schema_from_s3_netcdf("dummy_s3_path", self.sub_schema)
    ...
    def test_generate_json_schema_from_s3_netcdf(self, mock_s3fs, mock_xr_open_dataset):
        ...
        mock_dataset.variables = {
            ...
            'time': MagicMock(dtype='datetime64[ns]', attrs={'units': 'seconds since 1970-01-01'}),
        }
        mock_dataset.coords = {}

        # Call the function under test
        temp_file_path = generate_json_schema_from_s3_netcdf('s3://your-bucket/path/to/file.nc')
