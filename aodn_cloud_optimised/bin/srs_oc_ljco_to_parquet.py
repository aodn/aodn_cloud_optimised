...
def main():
    ...
    nc_obj_ls = s3_ls(BUCKET_RAW_DEFAULT, 'IMOS/SRS/OC/LJCO/WQM-daily/')

    dataset_config = load_dataset_config(str(importlib.resources.path("aodn_cloud_optimised.config.dataset", "srs_oc_ljco_wqm_daily.json")))
