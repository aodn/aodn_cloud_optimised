...
TEST_FILE_NC = os.path.join(ROOT_DIR, 'resources', 'IMOS_SOOP-XBT_T_20240218T141800Z_IX28_FV00_ID_9797539.nc')
...
class TestGenericHandler(unittest.TestCase):
    ...
    def test_add_columns_df_and_bad_timestamps(self):
        ...
        self.assertEqual(result_df.filename[0], 'IMOS_SOOP-XBT_T_20240218T141800Z_IX28_FV00_ID_9797539.nc')
    ...
    def test_create_data_parquet_with_mocked_parameters_and_with_schema(self):
        ...
        self.assertEqual(parquet_dataset['TIME'][0], pd.Timestamp('2024-02-18 14:18:00'))

    def test_push_metadata_aws_registry(self):

        # Load the registry config from the JSON file
        expected_yaml_data = yaml.dump(self.handler_with_schema.dataset_config["aws_opendata_registry"])
