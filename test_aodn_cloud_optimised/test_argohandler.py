...
class TestGenericHandler(unittest.TestCase):
    ...
    def setUp(self, mock_get_s3_raw_obj):
        ...
        self.tmp_nc_bad_geom_path = os.path.join(self.tmp_dir, os.path.basename(TEST_FILE_BAD_GEOM_NC))
        ...
        self.handler.cloud_optimised_output_path = os.path.join(self.tmp_dir, "dummy_table_name")
        self.handler_bad_geom.cloud_optimised_output_path = os.path.join(self.tmp_dir, "dummy_table_name")
    ...
    def test_add_columns_df_and_bad_timestamps(self):
        ...
        self.assertEqual(result_df['timestamp'][0], -9223372036.854776)  # This is a NAN value but all good!
    ...
    def test_create_data_parquet(self, mock_boto3_client):
        ...
        self.assertEqual(parquet_dataset['JULD'][0], pd.Timestamp('2013-02-26 03:15:00'))

        # Assert the expected values in the Parquet dataset
        self.assertNotIn('PSAL_ADJUSTED', parquet_dataset.columns)  # make sure the variable is removed
    ...
    def test_create_data_parquet_bad_geom(self, mock_boto3_client):
        ...
        self.handler_bad_geom.tmp_input_file = self.tmp_nc_bad_geom_path  # overwrite value in handler
