...
def main():
    ...
    for i, year in enumerate(range(2018, 2025)):
        command = [
            ...
            # "IMOS/SRS/SST/ghrsst/L3SM-1dS/dn/2021",  # 2021031* 202102* required a m7i-flex.large scheduler, otherwise it would fail!!
            ...
            # "/202103", # required a m7i-flex.xlarge for 20 days! failed with 30days
            "--dataset-config",
