...
class ArgoHandler(GenericHandler):
    ...
    def preprocess_data(self, netcdf_fp) -> Generator[Tuple[pd.DataFrame, xr.Dataset], None, None]:
        """
        ...
        with xr.open_dataset(netcdf_fp) as ds:
            ...
            df_profile_data['PLATFORM_NUMBER'] = df_profile_data['PLATFORM_NUMBER'].apply(
